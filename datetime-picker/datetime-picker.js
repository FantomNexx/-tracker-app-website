  ...
  Plugin.prototype =
    {
      ...
      initHours            : function(){
        ...
        for( var i = 0; i < 12; i++ ){
          ...
          var fill  = ((this.currentDate.format( hFormat ) == i) ? "#2867cc" : 'transparent');
        ...
        if( !this.params.shortTime ){
          for( var i = 0; i < 12; i++ ){
            ...
            var fill  = ((this.currentDate.format( hFormat ) == (i + 12)) ? "#2867cc" : 'transparent');
      ...
      initMinutes          : function(){
        ...
        for( var i = 0; i < 60; i++ ){
          ...
          var color = ((this.currentDate.format( "m" ) == i) ? "#2867cc" : 'transparent');
      ...
      _onSelectHour        : function( e ){
        if( !$( e.target ).hasClass( 'disabled' ) ){
          ...
          $( parent.find( '#h-' + value ) ).attr( 'fill', '#2867cc' );
      ...
      _onSelectMinute      : function( e ){
        if( !$( e.target ).hasClass( 'disabled' ) ){
          ...
          $( parent.find( '#m-' + value ) ).attr( 'fill', '#2867cc' );
